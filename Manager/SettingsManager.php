...
use Dmishh\SettingsBundle\Event\SettingUpdateEvent;
/**
...
class SettingsManager implements SettingsManagerInterface
{
     ...
     */
    public function __construct(ObjectManager $em, SerializerInterface $serializer, array $settingsConfiguration = array(), EventDispatcherInterface $eventDispatcher)
    {
        $this->em = $em;
    ...
    /**
     * Sets setting value to private array.
     * Used for settings' batch saving.
     *
     * @param string $name            
     * @param mixed $value            
    ...
    private function getSettingsFromRepository(SettingsOwnerInterface $owner = null)
    {
        ...
        /** @var Setting $setting */
        foreach ($this->repository->findBy(array(
            'ownerId' => $owner === null ? null : $owner->getSettingIdentifier()
        )) as $setting) {
